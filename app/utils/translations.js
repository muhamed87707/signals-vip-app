export const translations = {
        en: {
                ...
                deleteSuccess: 'Signal deleted successfully!',
                deleteError: 'Failed to delete signal',
                ...
                addNewVip: 'Add New VIP Member',
                durationMonths: 'Duration (Months)',
                lifetime: 'Lifetime',
                remove: 'Remove',
                noVipMembers: 'No active VIP members',
                status: 'Status',
                expiresIn: 'Expires In',
                actions: 'Actions',
                ...
                generatePosts: 'Generate AI Posts',
                generating: 'Generating...',
                generatedVariations: 'Generated Variations',
                selectVariation: 'Click to select this variation',
...
Past performance of any trading system or methodology is not necessarily indicative of future results. No representation is being made that any account will or is likely to achieve profits or losses similar to those shown.`,
        ...
        ar: {
                ...
                signalsTab: 'التوصيات',
                vipTab: 'إدارة VIP',
                settingsTab: 'إعدادات الذكاء الاصطناعي',
                ...
                deleteSuccess: 'تم حذف التوصية بنجاح!',
                deleteError: 'فشل في حذف التوصية',
                ...
                updateSignal: 'تحديث التوصية',
                confirmUpdate: 'تأكيد وتحديث الآن',
                addNewVip: 'إضافة عضو VIP جديد',
                durationMonths: 'المدة (بالأشهر)',
                lifetime: 'مدى الحياة',
                remove: 'إزالة',
                noVipMembers: 'لا يوجد أعضاء VIP نشطين',
                status: 'الحالة',
                expiresIn: 'تنتهي خلال',
                actions: 'الإجراءات',
                
                // AI Settings
                aiSettings: 'إعدادات الذكاء الاصطناعي (Gemini)',
                apiKey: 'مفتاح API',
                model: 'النموذج',
                postCount: 'عدد المنشورات',
                customPrompt: 'القالب المخصص',
                saveSettings: 'حفظ الإعدادات',
                settingsSaved: 'تم حفظ الإعدادات بنجاح!',
                generatePosts: 'توليد منشورات بالذكاء الاصطناعي',
                generating: 'جاري التوليد...',
                generatedVariations: 'النسخ المولدة',
                selectVariation: 'انقر لاختيار هذه النسخة',
...
**3. سياسة عدم الاسترداد (No Refund Policy)**
